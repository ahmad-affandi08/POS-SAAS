...
- Test arsitektur (`Backend/tests/Arsitektur/`) dan test vector (`Spesifikasi/VektorUjiKalkulasi/`) **terlindungi**: hanya manusia yang mengubah. Kalau test tersebut gagal, perbaiki kodenya.
