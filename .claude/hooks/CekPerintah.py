...
from Bersama import BacaMasukan, KeputusanPreToolUse  # noqa: E402
...
PathPenjaga = r"(CLAUDE\.md|\.claude/|Alat/|\.github/|PRD\.md|Dokumen/|VektorUjiKalkulasi|tests/Arsitektur|phpstan|pint\.json|rector\.php|phpunit\.xml|eslint\.config|analysis_options\.yaml|dart_test\.yaml|melos\.yaml)"
...
if re.search(PathPenjaga, Datar) and re.search(PolaTulis, Datar):
