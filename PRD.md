...
- **Belum**: printer USB & all-in-one (Sunmi, iMin), fallback printer sistem, Wizard Uji Perangkat & `Perangkat.ProfilHardware`.
...
- **Belum:** tampilan "Poin 2×" di keranjang kasir & struk, laporan uplift, pendanaan promo (Beban Promosi/bagi pemasok), gratis ongkir.
