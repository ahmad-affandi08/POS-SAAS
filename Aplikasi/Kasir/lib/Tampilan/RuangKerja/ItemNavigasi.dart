...
enum TujuanRuangKerja { Jual, Kas, Shift, StatusSinkron, Pengaturan }
...
class ItemNavigasi {
  ...
  /// [TujuanRuangKerja]): Order tersimpan (F-07), Meja (modul `Meja`), Riwayat transaksi (F-07), Pelanggan (modul
  /// `Pelanggan`).
