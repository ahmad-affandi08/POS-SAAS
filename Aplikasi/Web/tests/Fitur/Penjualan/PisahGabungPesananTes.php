...
describe('v1.99 pisah tagihan & gabung meja', function (): void {
    it('pisah: item terpilih pindah ke pesanan baru, keduanya dibayar terpisah; stok & jurnal dari penjualan, tiket dapur tetap', function (): void {
        ...
        expect(KirimPesanan($this, $k, [$pisah, $pindah]))->toBe([['Diterima', null], ['Diterima', null]])
            ->and(KirimPesanan($this, $k, [$pindah]))->toBe([['Duplikat', null]]);
        ...
        expect(KirimPesanan($this, $k, [$bayar1, $bayar2]))->toBe([['Diterima', null], ['Diterima', null]])
    ...
    it('gabung: semua item meja 9 pindah ke meja 7, meja 9 ditutup Digabung; pesanan tertutup menolak pindah; beda outlet ditolak', function (): void {
        ...
        KirimPesanan($this, $k, [$buka7, $tambah7, $buka9, $tambah9]);
        ...
        expect(KirimPesanan($this, $k, [$gabung]))->toBe([['Diterima', null]]);
        ...
        KirimPesanan($this, $k, [$buka10, $tambah10]);
        ...
        expect(KirimPesanan($this, $k, [$keTutup])[0])->toBe(['Ditolak', 'PesananSudahDitutup']);
        ...
        expect(KirimPesanan($this, $k, [$keDiri])[0])->toBe(['Ditolak', 'TujuanSama']);
    });
});
