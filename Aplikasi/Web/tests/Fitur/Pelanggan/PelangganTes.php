...
describe('F-16a pelanggan di POS', function (): void {
    ...
    it('API cari: minimal 3 karakter, nama atau nomor HP, pelanggan diarsipkan & tenant lain tidak muncul, nomor tersamar', function (): void {
        ...
        expect($cari('an'))->toBe([])
            ->and($cari('ani'))->toBe([['Uuid' => Pelanggan::withoutGlobalScopes()->where('Nama', 'Ani Rahmawati')->value('Uuid'), 'Nama' => 'Ani Rahmawati', 'NoHp' => '0812****7890', 'KodeTier' => null, 'NamaTier' => null, 'SaldoPoin' => 0]])
