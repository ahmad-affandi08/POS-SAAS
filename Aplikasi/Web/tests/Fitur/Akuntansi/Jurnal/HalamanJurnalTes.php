...
describe('F-05a halaman jurnal baca saja (DesainF05a D/E, H-13)', function (): void {
    it('daftar jurnal: terbaru di atas, tautan sumber, penanda pembalik & dibalik, opsi jenis sumber', function (): void {
        ...
        BantuanPersediaan::MasukSebagai($this, $t['Tenant']->Id)->get('/kelola/akuntansi/jurnal')
            ...
            ->assertInertia(fn (AssertableInertia $h) => $h
                ...
                ->missing('Saring')
                ->where('OpsiJenisSumber', [['Nilai' => 'StokAwal', 'Label' => 'Stok awal'], ['Nilai' => 'MutasiKas', 'Label' => 'Kas masuk/keluar'], ['Nilai' => 'Penjualan', 'Label' => 'Penjualan'], ['Nilai' => 'ReturPenjualan', 'Label' => 'Retur penjualan'], ['Nilai' => 'TutupShift', 'Label' => 'Selisih kas tutup shift'], ['Nilai' => 'TransaksiKasBank', 'Label' => 'Transaksi kas & bank'], ['Nilai' => 'TransferStok', 'Label' => 'Transfer stok'], ['Nilai' => 'StokOpname', 'Label' => 'Stok opname'], ['Nilai' => 'PenyesuaianStok', 'Label' => 'Penyesuaian stok'], ['Nilai' => 'PenerimaanBarang', 'Label' => 'Penerimaan barang'], ['Nilai' => 'FakturPembelian', 'Label' => 'Faktur pembelian'], ['Nilai' => 'PembayaranHutang', 'Label' => 'Pembayaran hutang'], ['Nilai' => 'ReturPembelian', 'Label' => 'Retur pembelian'], ['Nilai' => 'PembayaranPiutang', 'Label' => 'Pelunasan piutang'], ['Nilai' => 'PesananPenjualan', 'Label' => 'Uang muka pre-order'], ['Nilai' => 'TutupTahun', 'Label' => 'Tutup tahun'], ['Nilai' => 'Kasbon', 'Label' => 'Kasbon karyawan'], ['Nilai' => 'PelunasanKasbon', 'Label' => 'Pelunasan kasbon'], ['Nilai' => 'RekapGaji', 'Label' => 'Rekap gaji'], ['Nilai' => 'PenerimaanKlaimPemasok', 'Label' => 'Penerimaan klaim promo pemasok'], ['Nilai' => 'IsiDeposit', 'Label' => 'Isi deposit pelanggan'], ['Nilai' => 'MutasiDeposit', 'Label' => 'Penarikan/penyesuaian deposit'], ['Nilai' => 'PemakaianSesi', 'Label' => 'Pemakaian paket sesi'], ['Nilai' => 'MutasiSesi', 'Label' => 'Pengembalian/hangus paket sesi']]));
    });
    ...
    it('saringan kata, rentang tanggal, dan jenis; nilai tidak valid diabaikan; halaman lewat ?halaman', function (): void {
        ...
        $masuk()->getJson('/kelola/akuntansi/jurnal?saring[Tanggal]=31-08-2026..2026-02-30&saring[JenisSumber]=Produksi&cari=%25')->assertOk()
            ->assertJsonPath('Meta.Total', 0);
        $masuk()->getJson('/kelola/akuntansi/jurnal?saring[Tanggal]=31-08-2026..2026-02-30&saring[JenisSumber]=Produksi')->assertOk()
