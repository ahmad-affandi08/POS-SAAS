 ...
 * siap wizard, dan masuk sebagai anggota. Halaman Inertia panduan awal adalah berkas TSX milik tim frontend, jadi
 * test backend memeriksa nama komponen tanpa memeriksa keberadaan berkasnya (`HALAMAN_DIPERIKSA`).
 */
final class BantuanPanduanAwal
{
    public const HALAMAN_DIPERIKSA = false;
