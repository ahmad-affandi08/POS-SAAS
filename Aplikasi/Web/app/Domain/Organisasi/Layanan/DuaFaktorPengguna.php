...
/**
 * TOTP (RFC 6238) untuk 2FA akun tenant (§20.2). Sama dengan pola Platform Pengelola, tetapi berdiri sendiri karena
 * kode tenant tidak boleh memakai domain Pengelola (§13.8).
 */
final class DuaFaktorPengguna
{
    ...
    {
        return $this->google2fa->getQRCodeUrl((string) config('app.name'), $email, $rahasia);
    }
