...
Status: **Fase 1 inti selesai** (§22). Sudah ada: fondasi `Aplikasi/Web` (Laravel + back-office) dan Flutter, Platform Pengelola P-01 s.d. P-09 & P-11 (dasar), F-00, F-01, F-02, F-03, F-04 fase 1 (pembelian & hutang), F-05a, F-05b (transfer, opname, penyesuaian), F-06, F-07 (penjualan: mesin kalkulasi PHP & Dart, sinkron, layar Jual & Bayar), F-08 fase 1, F-09 fase 1 (void & retur), F-11 (tutup shift), F-13a (keuangan dasar), F-14a (laporan inti). Berikutnya: utang D-16 (audit responsif 360/768/1280px) dan utang §25, lalu flow fase 2 (F-07 mode meja + F-10 KDS, F-16, F-12, F-18).
