...
Status: **Fase 1 inti selesai** (§22). Sudah ada: fondasi `Aplikasi/Web` (Laravel + back-office) dan Flutter, Platform Pengelola P-01 s.d. P-09 & P-11 (dasar), F-00, F-01, F-02, F-03, F-04 fase 1 (pembelian & hutang), F-05a, F-05b (transfer, opname, penyesuaian), F-06, F-07 (penjualan: mesin kalkulasi PHP & Dart, sinkron, layar Jual & Bayar), F-08 fase 1, F-09 fase 1 (void & retur), F-11 (tutup shift), F-13a (keuangan dasar + neraca & arus kas), F-14a (laporan inti), audit responsif D-16c, F-10a (meja, area, stasiun dapur), F-07 mode meja + F-10b fase 1 (pesanan terbuka tersinkron, tiket dapur, layar Meja & layar dapur KDS di aplikasi), F-16a (data pelanggan: back-office, cari & buat di POS), F-16b (tier, harga tier, perolehan, kedaluwarsa & penukaran poin sebagai diskon), F-16c bagian 1 & 2 (promo otomatis offline; voucher & kode promo wajib online, kode massal + ekspor CSV), F-12 bagian 1 & 2 (limit kredit, penjualan tempo dengan PIN penyetuju, piutang & umur, pelunasan; pre-order dengan uang muka), F-18 bagian 1 & 2 (karyawan, jadwal kerja, absensi PIN + swafoto di POS, komisi per staf pelayan), cetak struk bagian 1, 2 & struk digital `/s/{kodeStruk}` (pengaturan struk di back-office, `Paket/AdaptorPerangkat` ESC/POS, printer LAN + Bluetooth Classic Android/Windows + Bluetooth LE iOS/Android/Windows, cetak otomatis/ulang, laci), F-15 (tutup harian per outlet, tutup bulan & buka kunci, transaksi POS di periode terkunci dibukukan di periode terbuka berikutnya, tutup tahun J-15.1), P-10 (rilis aplikasi bertahap, versi minimum, flag fitur & kill switch, kunci layar jual saat wajib perbarui). Berikutnya: cetak struk bagian 3 (struk retur/void/tutup shift, USB, Sunmi/iMin, wizard uji perangkat), F-18 bagian 3 (target, kasbon, rekap gaji), F-16c lanjutan (promo metode bayar, ulang tahun, batas per pelanggan).
