...
Slogan: **Bisnis Laris, Kelola Praktis.**

## Sumber (dari pemilik produk, jangan diedit)
...
- **Web**: `Aplikasi/Web/public/favicon.ico` (16/32/48), `public/apple-touch-icon.png` (180),
  `resources/js/Aset/Merek/{LogoHorizontal,IkonMerek}.png` (dipakai `Komponen/Merek/LogoMerek.tsx`).
