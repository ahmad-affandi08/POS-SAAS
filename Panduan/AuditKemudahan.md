...
| Tahu stok yang harus dibeli | Laporan stok → saring kritis → buat PO manual per produk | Tidak ada ajakan tindakan | Kotak Tindakan menampilkan stok kritis (C), draf PO otomatis (D) | C selesai: stok kritis tampil di Beranda/Kotak Tindakan dengan tautan; **D1 selesai:** draf PO disiapkan otomatis tiap pagi per pemasok, tinggal periksa & ajukan (0 isian) |
...
| Mulai pakai (usaha baru) | Wizard + atur satuan, kategori, pajak, metode bayar, meja, stasiun, produk satu per satu | Lama sebelum transaksi pertama | Pilih sektor → data awal lengkap, impor Excel/tempel teks (A) | **A selesai:** pilih sektor + 1 klik "Siapkan semuanya otomatis" (template, pajak, 12 produk contoh, Tunai) → tinggal aktifkan perangkat; produk sendiri cukup ditempel dari Excel/WhatsApp |
...
| Pemilik baru membuka back-office pertama kali (D-24) | Beranda + checklist yang bisa diabaikan; menu penuh terbuka walau toko belum siap | Toko "jalan" tanpa pajak/produk/metode bayar | Halaman panduan sendiri, wajib sampai siap | **D-24 selesai:** langsung ke panduan layar penuh; profil + sektor ("Siapkan semuanya otomatis") + perangkat "Nanti saja" → Beranda |
